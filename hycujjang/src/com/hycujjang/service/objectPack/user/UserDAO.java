package com.hycujjang.service.objectPack.user;
...
public class UserDAO {
	...
	public boolean hasEmailChecked(String userID) {
	...
	public boolean hasEmailChecked(UserDTO user) {
		return hasEmailChecked(user.getUserID());
	}
