...
<script>
	...
	<div class="container">
		수정하기
		<div>
			<form method="post" action="devStoryUpdateController">
				<table class="table">
					<thead>
						<tr>
					...
					<tbody>
						<tr>
							...
							<td>
								<input type="password" value="${content.boardPassword}" class="form-control" placeholder="비밀번호" name="password" maxlength="10">			
							</td>
						</tr>
						<tr>
							<td colspan="2">
								<input type="text" value="${content.boardTitle}" class="form-control" placeholder="글 제목" name="title" maxlength="50">
							</td>
						</tr>
						<tr>
							<td colspan="2">
								<input type="hidden" value="${content.boardID}" class="form-control" placeholder="닉네임" name="boardID" maxlength="10">
								<textarea id="summernote" name="content" class="summernote" maxlength="2048">${content.boardContent}</textarea>
							</td>
						</tr>
						<tr>
							<td colspan="2">
