 ...
 * Generated at: 2022-01-01 13:00:56 UTC
...
public final class userJoin_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("						<input type=\"text\" name=\"userID\" id=\"id\" class=\"form-control\" placeholder=\"아이디를 입력하세요 (모든 게시글은 익명 입니다.)\">\r\n");
      out.write("					</div>\r\n");
      ...
      out.write("		function sendController(data) {\r\n");
      ...
      out.write("			var data = {requestCode: 'register', \r\n");
      out.write("					id: document.getElementById(\"id\").value,\r\n");
      out.write("					pass: document.getElementById(\"pass_1\").value,\r\n");
      out.write("					email: document.getElementsByName('email')[0].value\r\n");
      out.write("			}		\r\n");
      out.write("			\r\n");
      out.write("			var response = sendController(data);\r\n");
      out.write("			if (response[0].resultCode == 'null') {\r\n");
      out.write("				alert('입력 안 된 사항이 있습니다.');\r\n");
      out.write("			} else if (response[0].resultCode == 'email') {\r\n");
      ...
      out.write("			var data = {requestCode: 'idCheck', id: document.getElementById(\"id\").value}	\r\n");
      out.write("			var response = sendController(data);\r\n");
      out.write("			if (response[0].resultCode == 'null') {\r\n");
      out.write("				alert('공백은 사용 할수 없습니다.');\r\n");
      out.write("			} else if (response[0].resultCode == 'Available') {\r\n");
      out.write("				alert('사용 가능합니다.');\r\n");
      out.write("			} else if (response[0].resultCode == 'unAvailable') {\r\n");
