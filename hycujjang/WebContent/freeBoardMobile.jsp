...
<body>
	...
	<div class="container">
		...
		<c:forEach var="freeBBS" items="${freeBBS}" begin="0" end="${freeBBSListPrintCount}">			
			<div class="row" onclick="location.href='freeBoardDetailController?id=${freeBBS.bbsID}';" style="height: auto; width: 100%; border-bottom:1px solid silver; padding: 6px;"> 
				<div class="col-12" style="display: block; text-overflow: ellipsis; overflow: hidden; white-space: nowrap;">${freeBBS.bbsTitle}				
					<c:if test="${freeBBS.commentCount != 0}"><span style="font-size: 12px; color:#00bfff;">[${freeBBS.commentCount}]</span></c:if>	
